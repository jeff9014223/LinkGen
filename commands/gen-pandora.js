...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/pandora.txt', 'utf8', function(err, data) {
            if (err) throw err;
            ...
            fs.writeFile('./accounts/pandora.txt', lines.slice(1).join('\n'), function(err) {
                if(err) throw err;
            });

            let embed = new Discord.MessageEmbed()
            .addField('LinkGen', `https://discord.gg/JqDAbN8Stq`)
            .addField('Pandora Account',`\n**${account}**`)
            .setColor("#363940")
...
var xd = new Discord.MessageEmbed()
        ...
        .setFooter("LinkGen")
        .setTimestamp()
        .setDescription("I've sent you 1 Pandora Account!")
...
module.exports.help = {
    name: `gen pandora`,
    description: `Sends you a Pandora Account!`
};