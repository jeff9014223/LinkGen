...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/creditcard.txt', 'utf8', function(err, data) {
            if (err) throw err;
            ...
            fs.writeFile('./accounts/creditcard.txt', lines.slice(1).join('\n'), function(err) {
                if(err) throw err;
            });

            let embed = new Discord.MessageEmbed()
            .addField('LinkGen', `https://discord.gg/JqDAbN8Stq`)
            .addField('CreditCard code',`\n**${account}**`)
            .setColor("#363940")
...
var xd = new Discord.MessageEmbed()
        ...
        .setFooter("LinkGen")
        .setTimestamp()
        .setDescription("I've sent you a Credit Card code!")
...
module.exports.help = {
    name: `gen creditcard`,
    description: `Sends you a Creditcard Code!`
};